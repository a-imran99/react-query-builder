...
import { AntdWidgets } from 'react-simple-query-builder/antd';
...
[source,javascript]
----
import {CustomOperators: {ProximityOperator}} from 'react-simple-query-builder/ui';
----
...
[source,javascript]
----
import {VanillaWidgets} from 'react-simple-query-builder/ui';
import {AntdWidgets} from 'react-simple-query-builder/antd';
import {MuiWidgets} from 'react-simple-query-builder/mui';
import {MaterialWidgets} from 'react-simple-query-builder/material'; // MUI v4
...
[source,javascript]
----
import { BasicFuncs } from 'react-simple-query-builder/ui';
const config = {
  //...
  funcs: {
